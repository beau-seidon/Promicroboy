 ...
 *  Version:             1.4.0                                             *
 *  Date:                March 20 2026                                     *
 *  Name:                Beau Sterling (beau-seidon)                       *
 *  Email:               aether.soundlab@outlook.com                       *
 *                                                                         *
 *  Modified by:         tstirrat & crunchypotato                          *
 *                                                                         *
...
* User Settings
***************************************************************************/
boolean usbMode = false;        // to use usb for serial communication as opposed to MIDI - sets baud rate to 38400
