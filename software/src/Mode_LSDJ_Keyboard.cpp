...
void modeLSDJKeyboardSetup(void);
void modeLSDJKeyboard(void);
void modeLSDJKeyboardUsbMidiReceive(void);
void modeLSDJKeyboardSerialMidiReceive(void);
